...
** This file creates Appendix Table A.21
==============================================================================*/
...
-------------------------------------------------------------------------------------------------------*/
	...
	cap file close fh
	cap	macro drop fh 
	cap erase "$out/tab_balance_hh.tex"
	file open fh using "$out/tab_balance_hh.tex", write replace
		file write fh ///
		"\small" ///
